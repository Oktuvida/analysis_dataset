...
-- ALTER TABLE public."DescripcionDemografica" DROP CONSTRAINT IF EXISTS "Genero_fk" CASCADE;
ALTER TABLE public."DescripcionDemografica" ADD CONSTRAINT "Genero_fk" FOREIGN KEY ("id_Genero")
